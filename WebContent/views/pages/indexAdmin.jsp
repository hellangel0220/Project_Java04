...
<head>
    ...
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/owl.carousel.css">
    <link rel="stylesheet" href="/assets_admin/css/owl.theme.css">
    <link rel="stylesheet" href="/assets_admin/css/owl.transitions.css">
    <!-- meanmenu CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/meanmenu/meanmenu.min.css">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- jvectormap CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/jvectormap/jquery-jvectormap-2.0.3.css">
    <!-- notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/notika-custom-icon.css">
    <!-- wave CSS
		============================================ -->
    <link rel="stylesheet" href="/assets_admin/css/wave/waves.min.css">
    <!-- main CSS
		============================================ -->
    ...
    <!-- modernizr JS
		============================================ -->
    <script src="/assets_admin/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- meanmenu JS
		============================================ -->
    <script src="/assets_admin/js/meanmenu/jquery.meanmenu.js"></script>
    <!-- counterup JS
		============================================ -->
    <script src="/assets_admin/js/counterup/jquery.counterup.min.js"></script>
    <script src="/assets_admin/js/counterup/waypoints.min.js"></script>
    <script src="/assets_admin/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="/assets_admin/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- jvectormap JS
		============================================ -->
    <script src="/assets_admin/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/assets_admin/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/assets_admin/js/jvectormap/jvectormap-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="/assets_admin/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="/assets_admin/js/sparkline/sparkline-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="/assets_admin/js/flot/jquery.flot.js"></script>
    <script src="/assets_admin/js/flot/jquery.flot.resize.js"></script>
    <script src="/assets_admin/js/flot/curvedLines.js"></script>
    <script src="/assets_admin/js/flot/flot-active.js"></script>
    <!-- knob JS
		============================================ -->
    <script src="/assets_admin/js/knob/jquery.knob.js"></script>
    <script src="/assets_admin/js/knob/jquery.appear.js"></script>
    <script src="/assets_admin/js/knob/knob-active.js"></script>
    <!--  wave JS
		============================================ -->
    <script src="/assets_admin/js/wave/waves.min.js"></script>
    <script src="/assets_admin/js/wave/wave-active.js"></script>
    <!--  todo JS
		============================================ -->
    <script src="/assets_admin/js/todo/jquery.todo.js"></script>
    <!-- plugins JS
		============================================ -->
    <script src="/assets_admin/js/plugins.js"></script>
	<!--  Chat JS
		============================================ -->
    <script src="/assets_admin/js/chat/moment.min.js"></script>
    <script src="/assets_admin/js/chat/jquery.chat.js"></script>
    <!-- main JS
		============================================ -->
    <script src="/assets_admin/js/main.js"></script>
	<!-- tawk chat JS
		============================================ -->
    <script src="/assets_admin/js/tawk-chat.js"></script>
</body>
